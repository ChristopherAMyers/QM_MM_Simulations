...
class StatsReporter(object):
    def __init__(self, file, reportInterval, options, qm_atoms = [], qm_vel_file_loc='qm_vel.txt'):
        ...
        self._qm_vel_file = open(qm_vel_file_loc, 'w')
    ...
    def report(self, simulation, state):
        ...
        if self._jobtype == 'aimd':
            ...
            for v in vel[qm_atoms]:
                v = v / v.unit
                self._qm_vel_file.write('{:15.8E}  {:15.8E}  {:15.8E} \n'.format(v[0], v[1], v[2]))
